...
def main():
    ...
    if len(usb_devs()) == 1:
        ...
        os.system('/bin/cp -fr /home/lncm/secrets /mnt/data')
        os.system('/bin/cp -fr /home/lncm/bitcoin /mnt/data')
        os.system('/bin/cp -fr /home/lncm/lnd /mnt/data')
        os.system('/bin/cp -fr /home/lncm/nginx /mnt/data')
